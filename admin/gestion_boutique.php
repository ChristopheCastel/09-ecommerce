<?php 
    ...
    if(isset($_GET['action']) && $_GET['action'] == 'suppression')
    {
        ...
        // On rédfinit la valeur de l'indice 'action' dans l'URL afin d'entrer dans la condition IF permettant l'affichage des articles ($_GET['action'] == 'affichage')
    ...
    if(isset($_POST['reference'],$_POST['categorie'],$_POST['titre'],$_POST['description'],$_POST['couleur'],$_POST['taille'],$_POST['public'],$_POST['prix'],$_POST['stock']))
    {
        ...
        {
            // http://localhost/php/PHP/09-ecommerce/assets/uploads/1843-tee-shirt4.jpg
    ...
    if(isset($_GET['action']) && $_GET['action'] == 'ajout')
    {
        ...
        $msg = "<p class='col-7 bg-success text-white text-center mx-auto p-3 my-3'>L'article référence <strong>$_POST[reference]</strong> a été enregistré avec succès.</p>"; 
    ...
    elseif(isset($_GET['action']) && $_GET['action'] == 'modification')
    {
        ...
        $msg = "<p class='col-7 bg-success text-white text-center mx-auto p-3 my-3'>L'article référence <strong>$_POST[reference]</strong> a été modifié avec succès.</p>"; 
    }
        ...
        $data->bindValue(':description', $_POST['description'], PDO::PARAM_STR );$data->bindValue(':couleur', $_POST['couleur'], PDO::PARAM_STR );
...
<form method="post" enctype="multipart/form-data" class="row g-3">
    ...
    <div class="col-4">
        ...
        <!-- POur récupérer l'URL de la photo existante lors de la modification -->
